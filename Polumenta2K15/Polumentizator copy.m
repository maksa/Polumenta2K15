...
-(NSString*)polumenta {
	return [ self polumentizujSaOpcijom:self.opcija ];
}
...
-(NSString*)polumentizujSaOpcijom:(NSString*)opt {
	...
	NSString* t2 = slova[1][ arc4random_uniform([ slova[1] count ] - dec ) ];
    NSString* t3 = slova[2][ arc4random_uniform([ slova[2] count ] - 1 ) ];
